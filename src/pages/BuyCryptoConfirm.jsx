                  ...
                  <div className="main info">
                    ...
                    <ul className="list">
                      ...
                      <li>
                        ...
                        <div className="content">
                          <p>For</p>
                          <h6 className="price">VestCalendar</h6>
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="main details">
                    ...
                    <form action="/buy-crypto-details">
                      ...
                      <div className="group-button">
                        <button type="button" className="cancel btn-action-3">Cancel</button>
                        <button type="button" className="submit btn-action">Let’s move on!</button>
                      </div>
                    </form>
                  </div>
                </div>
