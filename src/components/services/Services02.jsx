...
function Services02(props) {
  ...
  const [dataBlock] = useState(
    {
      heading: 'Why choose VestCalendar',
      desc: 'VestCalendar has a variety of features that make it the best place to start trading',
    },
  );
                  ...
                  data.map((idx) => (
                    <li key={idx.id} className={idx.active}>
                      <div className={`icon ${idx.bg}`}>
                        <img src={idx.icon} alt="VestCalendar" />
                      </div>
          ...
          <div className="col-xl-6 col-md-12">
            <div className="services_image">
                ...
                <ul className="list-felling">

                  {
                    dataIcon.map((item, idx) => (
                      <li className="icon" key={`${new Date().toLocaleString() + idx}`}>
                        <Link to="##">
                          <img
                            src={item.icon}
                            alt="VestCalendar"
              ...
              <div className="crypto-box">
                <img className="arrow" src={arrow} alt="VestCalendar" />
                <div className="left">
                  <img src={bitcoin} alt="VestCalendar" />
                  <div>
                    <h6>BTC</h6>
                    <p>+1.46%</p>
                  </div>
                ...
                <div className="right">
                  ...
                  <img src={chart} alt="VestCalendar" />
                </div>
              </div>
              <div className="shape" />
              <div className="user-card">
                <div className="info">
                  <img src={avt} alt="VestCalendar" />
                  <h6>Esther Howard</h6>
